            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 space-y-4">
                ...
                <form action="{{ route('products.store') }}" method="post" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 placeholder-gray-500 @error('price') border-red-500 @enderror" id="price" name="price" value="{{ old('price') }}" placeholder="Ingrese el precio" required>
                        @error('price')
                            <span class="text-red-500 mt-1">{{ $message }}</span>
                        @enderror
                    </div>
