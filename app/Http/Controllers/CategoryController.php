...
class CategoryController extends Controller
{
    ...
    {
        $request->validate([
            'name' => 'required|string|max:255', // Validar que el nombre sea requerido y tenga un máximo de 255 caracteres
            'description' => 'nullable|string', // La descripción es opcional y debe ser una cadena de texto
        ]);
